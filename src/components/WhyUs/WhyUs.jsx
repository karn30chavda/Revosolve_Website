    ...
    <section className="bg-transparent py-20 md:py-16 px-4 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu">
      <div className="w-[90%] md:w-[80%] mx-auto flex flex-col gap-10 md:gap-16 items-start justify-start relative">
        ...
        <div className="flex flex-col items-start justify-end self-stretch shrink-0 relative">
          <div
            className="text-white text-left font-sans text-sm md:text-[1.125rem] font-normal relative uppercase opacity-30 tracking-[0.264px] mb-2 md:mb-0"
          >
            <span>[ WHY US ]</span>
          </div>

          <div className="flex flex-col md:flex-row md:items-center gap-0 md:gap-4 relative">
            <h2 className="text-[#CACBDB] text-left font-sans text-[2.2rem] md:text-[2.375rem] font-thin leading-tight uppercase">
              What Sets Us
            </h2>
            <div
              className="text-left font-sans text-[2.2rem] md:text-[2.375rem] font-bold mt-[-4px] md:mt-0"
              style={{
        ...
        <div className="hidden md:flex flex-row items-stretch justify-start self-stretch min-h-80 rounded-lg border-[0.1875rem] border-[#191B57] relative overflow-hidden bg-bg-primary/50 backdrop-blur-sm">
          {/* Left Side: List */}
          <div className="text-[#C4C5EC] text-left font-sans text-[1.25rem] font-normal relative w-[45%] p-20 z-10 leading-10.75 tracking-[-0.272px]">
          ...
          <div className="self-stretch shrink-0 w-[55%] relative overflow-hidden flex items-center justify-start">
            ...
            <div className="h-full w-full py-12 px-20 flex items-center justify-start relative z-20">
              <div className="text-[#C4C5EC] text-left font-sans text-[1.125rem] font-normal relative w-full leading-6 tracking-[-0.272px]">
                "{testimonial}"
              </div>
            </div>
          </div>
        ...
        <div className="md:hidden flex flex-col gap-0 items-start justify-start self-stretch relative w-full mb-8">
          ...
          <div className="rounded-t-lg border-[3px] border-[#191b57] p-8 flex flex-col items-start justify-center self-stretch h-[301px] relative bg-[#01031c]/40 backdrop-blur-sm">
            <ul className="text-[#c4c5ec] text-left font-sans text-base leading-[32px] font-normal list-disc pl-5 space-y-2 tracking-tight">
          ...
          >
            ...
            <div className="text-[#c4c5ec] text-center font-sans text-[1.1rem] leading-relaxed font-normal relative flex-1 tracking-tight z-10 px-4 italic opacity-90">
               "{testimonial}"
            </div>
          </div>
        </div>
