    ...
    <section className="bg-transparent pt-2 pb-10 md:py-12 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu font-sans z-20">
      ...
      >
        ...
        <img
          ...
          src="/LegacyTransformationSystems/cta_bg_pattern.svg"
          alt=""
          loading="lazy"
          decoding="async"
        />
        ...
        <div className="flex flex-col gap-4 items-center justify-start shrink-0 relative z-10 text-center max-w-4xl">
          ...
          >
            Modernizing legacy applications, migrating to the cloud, or redesigning enterprise architecture — we transform aging technology into secure, scalable, future-ready digital platforms.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center z-10 relative mt-4">
          <button
            onClick={() => handleNavigate("Talk to a Modernization Expert")}
          ...
          >
            ...
            <img
              src="/LegacyTransformationSystems/cta_conversation_arrow.svg"
          ...
          <button
            onClick={() => handleNavigate("Start Your Modernization Journey")}
      ...
      >
        ...
        <div className="flex flex-col gap-3 w-full z-10 relative">
          ...
          >
            <span className="font-sans text-base leading-6">Start Your Modernization Journey</span>
            <img
              className="shrink-0 w-3 h-3 group-hover:translate-x-1 transition-transform duration-300"
              src="/LegacyTransformationSystems/hero_btn_icon_2.svg"
              alt=""
