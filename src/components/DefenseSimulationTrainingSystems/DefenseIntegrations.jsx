...
const integrationsData = [
  [GraduationCap, "Learning Management (LMS)"],
  [IdentificationBadge, "HRMS"],
  [Buildings, "ERP Platforms"],
  [GlobeHemisphereWest, "Digital Twin Platforms"],
  [MapTrifold, "GIS Systems"],
  ...
  [Database, "Training Databases"],
  [ChartBar, "Performance Dashboards"],
];

const DefenseIntegrations = () => {
  return (
    <section
      id="integrations"
...
export default DefenseIntegrations;
