...
const EntWhatWeDo = () => {
  return (
    <section id="ent-what-we-do" className="relative w-full bg-[#01031c] py-12 lg:py-16 overflow-hidden font-sans scroll-mt-24 md:scroll-mt-28">
      {/* Decorative Glows */}
        ...
        >
          ...
          <div className="w-full lg:w-[55%] px-6 pb-8 pt-4 md:p-8 lg:p-12 xl:p-16 flex flex-col justify-center items-start gap-4 md:gap-6 lg:gap-8 text-left relative z-10">
            ...
            <p className="text-white text-sm md:text-lg xl:text-[20px] font-medium leading-relaxed font-sans">
              We help organizations build and modernize business applications that support day-to-day operations, automate workflows, and connect critical business functions.
            </p>
            ...
            <p className="text-[#CACBDB] text-[12px] md:text-[15px] xl:text-[16px] font-light leading-relaxed font-sans opacity-70">
              From internal operational platforms to customer-facing applications, we engineer scalable systems aligned with how enterprises actually operate.
            </p>
          </div>
