...
const problemsList = [
  {
    ...
    desc: "Teams spend valuable time manually extracting information from forms and PDFs, increasing error rates and impacting accuracy.",
    icon: <Keyboard size={28} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Paper-Based Processes",
    desc: "Physical files slow approvals, reduce visibility, and increase operational risk.",
    icon: <Files size={28} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Unstructured Information",
    desc: "Critical business information exists in documents but remains inaccessible for reporting, automation, and analytics.",
    icon: <PuzzlePiece size={28} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Slow Approval Cycles",
    desc: "Manual routing delays customer onboarding, compliance verification, procurement, and internal operations.",
    icon: <HourglassMedium size={28} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "No End-to-End Visibility",
    desc: "Organizations struggle to track document status, approvals, exceptions, and turnaround times.",
    icon: <EyeSlash size={28} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Compliance Challenges",
    desc: "Audit trails, version control, and document governance become increasingly difficult as volumes grow.",
    icon: <Scales size={28} className="text-[#FCCA71]" weight="light" />,
  },
];
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-6 lg:gap-12">
          <div className="flex flex-col items-start min-w-fit">
            ...
            <h2 className="text-[28px] md:text-[38px] xl:text-[42px] leading-tight tracking-tight text-left font-sans">
              <span className="font-black block">
                <span className="text-[#877BF1]">Documents </span>
                <span className="bg-linear-to-r from-[#877BF1] to-[#FCCA71] bg-clip-text text-transparent">should move </span>
              </span>
          ...
          <div className="max-w-xl lg:pb-1">
            <p className="text-[#CACBDB] text-sm font-normal leading-relaxed opacity-70 text-left">
              Every organization processes thousands of documents daily, yet many workflows still depend on manual verification, repetitive data entry, email approvals, and disconnected systems.
            </p>
          </div>
        </div>
          ...
          {problemsList.map((item, idx) => (
            <Motion.div
              ...
              style={{ 
                ...
                borderColor: "rgba(135, 123, 241, 0.18)"
              }}
            ...
            >
              ...
              {/* Top part: Icon */}
              <div className="w-10 h-10 flex items-center justify-center shrink-0 relative z-10 p-2 rounded-lg bg-[#877BF1]/10 border border-[#877BF1]/20 group-hover:bg-[#877BF1]/20 transition-all duration-300 mb-4">
                {item.icon}
              </div>
