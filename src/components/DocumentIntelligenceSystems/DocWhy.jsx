...
const whyData = [
  {
    title: "AI + OCR + Workflow in One Platform",
    desc: "No need for multiple products — the full document lifecycle in a single ecosystem.",
    icon: <Stack size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Human + AI Collaboration",
    desc: "Automation where possible. Human review where required.",
    icon: <Handshake size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Enterprise Ready",
    desc: "Secure, scalable, auditable, and API-first.",
    icon: <ShieldCheck size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "No-Code Journey Builder",
    desc: "Business teams can design workflows without development.",
    icon: <PuzzlePiece size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Production Ready",
    desc: "Designed for enterprise-scale document volumes.",
    icon: <RocketLaunch size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Continuously Learning Models",
    desc: "Extraction accuracy improves over time as human corrections feed back into the models.",
    icon: <Brain size={26} className="text-[#FCCA71]" weight="light" />,
  },
];
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-6 lg:gap-12 pb-6">
          ...
          <div className="max-w-xl lg:pb-1">
            <p className="text-[#CACBDB] text-sm font-normal leading-relaxed opacity-70 text-left">
              Most platforms handle OCR. RevoDox handles the entire document journey — from capture to decision.
            </p>
          </div>
        </div>
