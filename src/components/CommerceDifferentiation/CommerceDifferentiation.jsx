        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
          {differentiationData.map((item, idx) => (
            <Motion.div
              ...
              className={`flex flex-col justify-start items-start p-8 min-h-[280px] w-full bg-violet-400/10 rounded-[8px] border border-indigo-500/30 hover:border-indigo-500/60 cursor-pointer transition-all duration-300 relative group overflow-hidden ${item.colSpan}`}
            >
              {/* Card Glow Effect */}
