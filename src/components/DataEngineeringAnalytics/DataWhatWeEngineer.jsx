...
const buildItems = [
  {
    ...
    icon: <Database size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    title: "Data Warehousing",
    desc: "Modern data warehouses optimized for analytics, reporting, and business intelligence.",
    icon: <Warehouse size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
  ...
  },
  {
    ...
    icon: <Sparkle size={26} className="text-[#877BF1]" weight="light" />,
  },
];
