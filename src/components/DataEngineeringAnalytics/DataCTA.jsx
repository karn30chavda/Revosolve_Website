    ...
    <section className="bg-transparent pt-2 pb-10 md:py-12 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu font-sans z-20">
      ...
      >
        ...
        <img
          ...
          src="/DataEngineeringAnalytics/cta_bg_pattern.svg"
          alt=""
          loading="lazy"
          decoding="async"
        />
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center z-10 relative mt-4">
          <button
            onClick={() => handleNavigate("Talk to a Data Engineering Expert")}
          ...
          >
            ...
            <img
              src="/DataEngineeringAnalytics/cta_conversation_arrow.svg"
          ...
          <button
            onClick={() => handleNavigate("Build Your Enterprise Data Platform")}
