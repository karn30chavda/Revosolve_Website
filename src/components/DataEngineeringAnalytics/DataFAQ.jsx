...
const faqData = [
  {
    ...
    a: "Designing, building, and maintaining systems that collect, integrate, transform, and prepare data for analytics, reporting, and AI.",
  },
  {
    q: "What is the difference between Data Engineering and Data Analytics?",
    a: "Data Engineering builds the infrastructure and pipelines that make data available; Data Analytics interprets that data to generate business insights.",
  },
  {
    q: "Can you integrate data from multiple enterprise systems?",
    a: "Yes. We integrate ERP, CRM, HRMS, finance, IoT, cloud platforms, and third-party systems into unified enterprise data platforms.",
  },
  {
    q: "Which analytics platforms do you support?",
    a: "Power BI, Tableau, Looker, Apache Superset, and custom analytics platforms.",
  },
  {
    q: "Do you build AI-ready data platforms?",
    a: "Yes. We design architectures that support machine learning, Generative AI, predictive analytics, and enterprise AI initiatives.",
  },
  {
    q: "How do you ensure data quality?",
    a: "Governance frameworks, validation rules, master data management, metadata, lineage tracking, and automated quality checks.",
  },
];
