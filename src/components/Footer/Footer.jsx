...
const footerData = {
  services: [
    ...
    "Data Engineering and Test Automation",
  ],
  solutions: [
    ...
    >
      ...
      <div className="flex md:hidden flex-col gap-4 items-center justify-center w-[90%] relative z-30 pb-4 pt-4 text-center">
        ...
        <div className="flex flex-row items-center justify-center gap-6">
          <Link to="/coming-soon" className="text-[#99A1AF] font-normal text-[0.875rem] leading-5 hover:text-white transition-colors" style={{ letterSpacing: "-0.00938rem", opacity: 0.7 }}>Privacy Policy</Link>
          <Link to="/coming-soon" className="text-[#99A1AF] font-normal text-[0.875rem] leading-5 hover:text-white transition-colors" style={{ letterSpacing: "-0.00938rem", opacity: 0.7 }}>Terms</Link>
          <Link to="/coming-soon" className="text-[#99A1AF] font-normal text-[0.875rem] leading-5 hover:text-white transition-colors" style={{ letterSpacing: "-0.00938rem", opacity: 0.7 }}>Cookies</Link>
        </div>
      </div>
    </footer>
  );
