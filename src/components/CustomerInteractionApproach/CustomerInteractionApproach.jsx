          ...
          {flowStages.map((step, idx) => {
            ...
            return (
              <div
                ...
                className={`flex items-center gap-4 p-4 rounded-[6px] border cursor-pointer transition-all duration-300 relative group overflow-hidden ${
                  isActive
                    ? "border-[#877BF1] bg-[#121344] shadow-[0_0_12px_rgba(135,123,241,0.12)]"
                    : "border-[#877BF1]/18 bg-[#0F1034]/40 hover:border-[#877BF1]/30 hover:bg-[#0F1034]/55"
              ...
              >
                ...
                <div className="relative w-9 h-9 flex items-center justify-center shrink-0">
                  <svg className="absolute inset-0 w-full h-full transform -rotate-90 z-0" viewBox="0 0 24 24">
                    ...
                    {isActive && (
                      <Motion.circle
                        ...
                        animate={{ strokeDashoffset: isPaused ? 0 : 0 }}
                        transition={{ duration: isPaused ? 0.3 : STEP_DURATION / 1000, ease: "linear" }}
                      />
                    )}
                  </svg>
                  ...
                  <div className={`relative z-10 transition-colors duration-300 ${
                    isActive ? "text-[#FCCA71]" : "text-[#877BF1]/60 group-hover:text-[#FCCA71]"
                  }`}>
                    <Icon
                      size={16}
                  ...
                  <div className="flex items-center gap-2.5 flex-wrap">
                    <h3
                      className={`font-semibold text-[14.5px] transition-colors duration-300 ${
                        isActive ? "text-white" : "text-[#E7E6FC] group-hover:text-white"
                      }`}
                    >
                      {step.title}
                    </h3>
                ...
                <span
                  className={`text-[11px] font-mono tracking-widest shrink-0 ml-3 transition-colors duration-300 ${
                    isActive ? "text-[#FCCA71]/80" : "text-[#5C5F85] group-hover:text-[#FCCA71]/80"
                  }`}
                >
                  {step.n}
                </span>
