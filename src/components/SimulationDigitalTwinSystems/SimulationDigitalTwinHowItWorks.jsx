...
const flowStages = [
  {
    ...
    desc: "Cities, networks, plants, utilities — the real world as it operates.",
  },
  {
    n: "02",
    icon: MapTrifold,
    title: "GIS Mapping",
    desc: "Every asset located, layered, and geographically contextualized.",
  },
  {
    n: "03",
    icon: CubeTransparent,
    title: "3D Model Generation",
    desc: "Infrastructure becomes an explorable digital environment.",
  },
  {
    n: "04",
    icon: Broadcast,
    title: "IoT Sensors",
    desc: "Live telemetry streams into the model, continuously.",
  },
  {
    n: "05",
    icon: Database,
    title: "Enterprise Systems",
    desc: "ERP, asset, and workflow data enrich the twin with business context.",
  },
  {
    n: "06",
    icon: Brain,
    title: "AI Analytics",
    desc: "Patterns detected, anomalies flagged, failures predicted.",
  },
  {
    n: "07",
    icon: GlobeHemisphereWest,
    title: "Digital Twin Platform",
    desc: "One living, synchronized model of the entire operation.",
  },
  {
    n: "08",
    icon: Monitor,
    title: "Operational Monitoring",
    desc: "Health, alarms, incidents, and KPIs tracked in real time.",
  },
  {
    n: "09",
    icon: Shuffle,
    title: "Simulation Engine",
    desc: "Test scenarios digitally before committing resources physically.",
  },
  {
    n: "10",
    icon: Compass,
    title: "Decision Support",
    desc: "AI-backed recommendations, not just visualizations.",
  },
  {
    n: "11",
    icon: ProjectorScreenChart,
    title: "Command Center",
    desc: "Leadership sees, understands, and directs operations from one place.",
  },
];

const SimulationDigitalTwinHowItWorks = () => {
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-6 lg:gap-12">
            ...
            <div className="max-w-xl lg:pb-1 shrink-0 lg:w-[45%]">
              <p className="text-[#CACBDB] text-[13.5px] md:text-[14px] font-normal leading-relaxed opacity-70 text-left">
                Follow the chain: physical infrastructure is mapped, modeled, sensed, and synchronized — then AI, simulation, and decision support turn the twin into a command center.
              </p>
            </div>
          </div>
        </Motion.div>
          ...
          {flowStages.map((step, idx) => {
            ...
            return (
              <div
                ...
                } ${isLast && flowStages.length % 2 !== 0 ? "md:col-span-2 md:max-w-[70%] md:mx-auto md:w-full" : ""}`}
              >
...
export default SimulationDigitalTwinHowItWorks;
