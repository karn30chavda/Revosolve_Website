...
const industriesList = [
  {
    ...
    desc: "Digitizing governance, citizen services, field operations, document processing, project monitoring, and public infrastructure workflows.",
    icon: <Bank size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Banking & Financial Institutions",
    desc: "Customer onboarding, KYC/KYB, workflow automation, business rules, compliance, and operational efficiency.",
    icon: <CurrencyCircleDollar size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Retail, D2C & Commerce",
    desc: "Commerce operations, inventory management, order orchestration, warehouse operations, fulfillment, and customer communication.",
    icon: <ShoppingCart size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Manufacturing",
    desc: "Production workflows, procurement, quality management, asset management, inventory visibility, and operational reporting.",
    icon: <Factory size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Healthcare & Life Sciences",
    desc: "Healthcare operations, workflow automation, compliance, patient management, and secure data-driven platforms.",
    icon: <Heartbeat size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Infrastructure, EPC & Engineering",
    desc: "Project lifecycle management, tender operations, workforce management, field execution, asset tracking, and billing.",
