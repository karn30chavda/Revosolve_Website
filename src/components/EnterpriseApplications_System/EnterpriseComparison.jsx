...
const ACCENT = "#877BF1";
const ACCENT2 = "#A9A0F5";
const GOLD = "#FCCA71";
const BORDER2 = "rgba(135,123,241,0.45)";

const compare = [
  {
    dim: "Starting Point",
    trad: "Starts with technology and feature lists",
    revo: "Starts with operational workflows and users",
  },
  {
    dim: "System Design",
    trad: "Isolated, standalone applications",
    revo: "Integrated operational systems",
  },
  {
    dim: "User Focus",
...
const EnterpriseComparison = () => {
  ...
  useEffect(() => {
    const dur = 3000; // 3 seconds total duration
    const interval = 30; // 30ms update interval for high-framerate fluid progress
    const t = setInterval(() => {
  ...
  return (
    <section className="relative w-full bg-[#01031c] pt-4 pb-6 lg:pt-6 lg:pb-8 overflow-hidden z-20">
      ...
      <div className="relative z-10 w-[85%] mx-auto font-sans">
        ...
        {/* Section Tag */}
        <div className="text-white/30 text-[10px] md:text-xs font-semibold uppercase tracking-[3px] mb-5">
          [Traditional Development vs RevoSolve Engineering]
        </div>

        {/* Main Grid Wrapper */}
        <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-6 lg:gap-10 items-stretch w-full">
            ...
            {compare.map((c, i) => {
              ...
              return (
                <button
                  key={c.dim}
                  onClick={() => goCmp(i)}
                  className="w-full text-left bg-transparent border-t border-white/10 py-2.5 flex flex-col gap-1 cursor-pointer transition-colors duration-300 group outline-hidden"
                >
                  <span
                  ...
                  <div className="h-[3px] w-full bg-[#0A0B28] relative overflow-hidden mt-0.5">
                    <div
          ...
          <div className="border border-white/10 rounded-lg flex flex-col min-h-[270px] w-full overflow-hidden bg-[#0A0B28]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 flex-1 relative">
              ...
              <div className="relative p-6 md:p-7 overflow-hidden bg-linear-to-b from-[#12143e]/40 to-[#0a0b28]/30">
                ...
                <div
                  className="absolute -top-10 -right-8 w-44 h-44 bg-radial from-[#877BF1]/20 to-transparent blur-xl pointer-events-none"
                  style={{
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 z-20 pointer-events-none hidden md:block">
                <span
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 border border-[#877BF1]/60 rounded-full animate-ping"
