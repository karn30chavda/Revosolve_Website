  ...
  return (
    <section className="bg-transparent pt-2 pb-10 md:py-12 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu font-sans z-20">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(290deg, #877BF1 -65.3%, #070784 64.5%), #151618",
        }}
      >
        {/* Background Pattern */}
        <img
          ...
          src="/EnterpriceApplication_System/cta_bg_pattern.svg"
          alt=""
          loading="lazy"
          decoding="async"
        />
        ...
        <div className="flex flex-col gap-4 items-center justify-start shrink-0 relative z-10 text-center max-w-4xl">
          ...
          >
            Modernize with operational discovery, workflow automation, and enterprise-grade architectures that improve reliability, accelerate delivery, and support long-term growth.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center z-10 relative mt-4">
          <button
            onClick={() => handleNavigate("Build Your Enterprise System")}
            className="btn-premium-glow rounded-sm py-4 px-8 flex flex-row gap-2.5 items-center justify-start shrink-0 relative group transition-all duration-300 cursor-pointer active:scale-95 text-[#070784]"
          >
            <span
            ...
            <img
              src="/EnterpriceApplication_System/cta_conversation_arrow.svg"
              className="shrink-0 w-5 h-5 relative overflow-visible group-hover:translate-x-1.5 transition-transform duration-300"
              alt=""
            />
          </button>

          <button
            onClick={() => handleNavigate("Talk to an Enterprise Solutions Expert")}
          ...
          >
            <span className="font-sans text-[1rem] leading-6 tracking-tight">
              Talk to an Enterprise Solutions Expert
            </span>
            <img
      ...
      <div
        ...
        style={{
          background: "linear-gradient(-70.26deg, #877BF1 0%, #070784 100%)",
        }}
      >
        <img
        ...
        <div className="flex flex-col gap-3 w-full z-10 relative">
          <button
            onClick={() => handleNavigate("Talk to a Systems Architect")}
            className="btn-premium-glow rounded py-4 px-6 flex flex-row gap-2.5 items-center justify-center w-full transition-all duration-300 cursor-pointer active:scale-95 group text-[#070784]"
          >
            <span
          ...
          <button
            onClick={() => handleNavigate("Build Your Enterprise Platform")}
