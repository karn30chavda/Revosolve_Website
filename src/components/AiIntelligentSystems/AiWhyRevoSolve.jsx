...
const AiWhyRevoSolve = () => {
  return (
    <section id="ai-why-revosolve" className="relative w-full bg-[#01031c] py-12 lg:py-16 overflow-hidden font-sans scroll-mt-24 md:scroll-mt-28">
      {/* Decorative Glows */}
        ...
        >
          ...
          <div className="w-full lg:w-[45%] px-6 pt-8 pb-4 md:p-8 lg:p-12 xl:p-16 flex flex-col justify-center items-start text-left relative z-10">
            ...
            <h3 className="text-3xl md:text-[38px] xl:text-[44px] font-black leading-tight tracking-[0.264px] mb-2 font-sans">
              <span className="text-[#877BF1]">Why </span>
              <span className="bg-linear-to-r from-[#877BF1] to-[#FCCA71] bg-clip-text text-transparent">RevoSolve</span>
            </h3>
          ...
          <div className="w-full lg:w-[55%] px-6 pb-8 pt-4 md:p-8 lg:p-12 xl:p-16 flex flex-col justify-center items-start gap-4 md:gap-6 lg:gap-8 text-left relative z-10">
            ...
            <p className="text-white text-sm md:text-lg xl:text-[20px] font-medium leading-relaxed font-sans">
              Most AI initiatives begin with experimentation. Very few successfully become part of operational workflows.
            </p>

            {/* Bottom paragraph: Lighter, thinner grey */}
            <p className="text-[#CACBDB] text-[12px] md:text-[15px] xl:text-[16px] font-light leading-relaxed font-sans opacity-70">
              RevoSolve focuses on designing AI systems that integrate into how organizations actually work — connecting people, processes, and data to create measurable outcomes.
            </p>
          </div>
