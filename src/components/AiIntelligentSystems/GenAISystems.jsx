...
const systemsData = [
  {
    ...
    icon: <Robot size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    num: "02",
    ...
    icon: <Chats size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    num: "03",
    title: "Voice AI Systems",
    desc: "Voice interaction platforms powered by ASR, TTS, Natural Language Understanding, and LLMs.",
    icon: <Waveform size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    num: "04",
    ...
    icon: <FileText size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    num: "05",
    ...
    icon: <Brain size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    num: "06",
  ...
  },
  {
    ...
    icon: <Compass size={26} className="text-[#877BF1]" weight="light" />,
  },
  {
    num: "08",
  ...
  },
  {
    ...
    icon: <Plugs size={26} className="text-[#877BF1]" weight="light" />,
  },
];
