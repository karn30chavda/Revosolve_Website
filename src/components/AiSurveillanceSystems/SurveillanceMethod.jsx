...
const methodSteps = [
  {
    title: "Assess",
    desc: "Evaluate operational environment, surveillance infrastructure, objectives, and monitoring requirements.",
    icon: MagnifyingGlass,
  },
  {
    title: "Design",
    desc: "Configure AI models, camera coverage, operational rules, dashboards, and workflows.",
    icon: CompassTool,
  },
  {
    title: "Deploy",
    desc: "Integrate with existing CCTV infrastructure while minimizing operational disruption.",
    icon: RocketLaunch,
  },
  {
    title: "Validate",
    desc: "Test detection accuracy, alert mechanisms, workflow integration, and operational scenarios.",
    icon: CheckSquare,
  },
  {
    title: "Optimize",
    desc: "Continuously improve detection models, operational rules, dashboards, and reporting.",
    icon: ChartLineUp,
  },
];

const SurveillanceMethod = () => {
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-6 lg:gap-12 pb-6">
          ...
          <div className="max-w-xl lg:pb-1">
            <p className="text-[#CACBDB] text-sm font-normal leading-relaxed opacity-70 text-left">
              A structured, feedback-driven lifecycle to integrate AI capabilities into your existing camera networks, running continuously from initial discovery to real-time alerting.
            </p>
          </div>
        </div>
...
export default SurveillanceMethod;
