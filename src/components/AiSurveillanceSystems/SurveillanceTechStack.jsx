...
const techCats = [
  {
    ...
    items: [
      ...
      { name: "Generative AI", icon: Sparkle },
    ],
  },
  {
    cat: "AI Frameworks",
  ...
  {
    cat: "Edge & Video Processing",
    items: [
      { name: "NVIDIA Jetson", icon: Cpu },
      { name: "NVIDIA DeepStream", icon: Broadcast },
      { name: "ONVIF", icon: VideoCamera },
      { name: "RTSP", icon: PlugsConnected },
    ],
  },
  {
    cat: "Backend",
        ...
        <div className="flex flex-col items-center justify-center w-full text-center pb-4">
          ...
          <h2 className="text-[28px] md:text-[38px] xl:text-[42px] leading-tight tracking-tight text-center font-sans">
            <span className="bg-linear-to-r from-[#877BF1] to-[#FCCA71] bg-clip-text text-transparent font-black block">
              The Vision Intelligence
            </span>
            <span className="text-[#CACBDB] font-light xl:font-thin block mt-1">
              toolchain and engineering stack
            </span>
          </h2>
        </div>
...
export default SurveillanceTechStack;
