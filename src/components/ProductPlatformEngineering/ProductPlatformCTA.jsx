    ...
    <section className="bg-transparent pt-2 pb-10 md:py-12 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu font-sans z-20">
      ...
      >
        ...
        <img
          ...
          src="/ProductPlatformEngineering/cta_bg_pattern.svg"
          alt=""
          loading="lazy"
          decoding="async"
        />
        ...
        <div className="flex flex-col gap-4 items-center justify-start shrink-0 relative z-10 text-center max-w-4xl">
          ...
          >
            Build products that continue creating value{" "}
            <span 
          ...
          >
            Launching a new SaaS platform, modernizing an application, or engineering a business-critical product — we build technology designed for long-term success.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center z-10 relative mt-4">
          <button
            onClick={() => handleNavigate("Start Your Product Journey")}
          ...
          >
            ...
            <img
              src="/ProductPlatformEngineering/cta_conversation_arrow.svg"
          ...
          <button
            onClick={() => handleNavigate("Talk to Our Engineering Team")}
...
export default ProductPlatformCTA;
