...
const ProductPlatformTechStack = () => {
  const [activeTab, setActiveTab] = useState(0);

  return (
    <section id="stack" className="relative w-full bg-transparent py-16 lg:py-24 overflow-hidden z-20 font-sans scroll-mt-20">
        ...
        <div className="flex flex-col items-center justify-center w-full text-center pb-4">
          ...
          <h2 className="text-[28px] md:text-[38px] xl:text-[42px] leading-tight tracking-tight text-center font-sans">
            <span className="bg-linear-to-r from-[#877BF1] to-[#FCCA71] bg-clip-text text-transparent font-black block">
              Chosen for longevity, not trends
            </span>
          </h2>
          <p className="text-[#CACBDB] font-normal mt-5 max-w-3xl leading-relaxed text-sm md:text-base opacity-70 text-center">
            Modern engineering means choosing technologies that support long-term scalability — not simply following trends.
          </p>
        </div>
        ...
        <div className="w-full flex flex-col items-center gap-4">
          ...
          <AnimatePresence mode="wait">
            <Motion.div
              ...
              className="w-full max-w-4xl mt-0 p-2 text-center relative"
            >
...
export default ProductPlatformTechStack;
