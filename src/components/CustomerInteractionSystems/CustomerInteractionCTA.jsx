    ...
    <section className="bg-transparent pt-2 pb-10 md:py-12 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu font-sans z-20">
      ...
      >
        ...
        <img
          ...
          src="/CustomerInteractionSystems/cta_bg_pattern.svg"
          alt=""
          loading="lazy"
          decoding="async"
        />
        ...
        <div className="flex flex-col gap-4 items-center justify-start shrink-0 relative z-10 text-center max-w-4xl">
          ...
          >
            Every customer conversation should{" "}
            <span 
          ...
          >
            Transform disconnected communication channels into one intelligent
            operational platform that improves customer experience, reduces
            operational effort, and enables faster decision-making.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center z-10 relative mt-4">
          <button
            onClick={() => handleNavigate("Book a Solution Demonstration")}
          ...
          >
            ...
            >
              Book a Solution Demonstration
            </span>
            <img
              src="/CustomerInteractionSystems/cta_conversation_arrow.svg"
          ...
          <button
            onClick={() => handleNavigate("Talk to a CX Architect")}
...
export default CustomerInteractionCTA;
