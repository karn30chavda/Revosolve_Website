...
const techCats = [
  ...
  },
  {
    cat: "Integrations",
    items: [
      { name: "GST Portal", icon: Receipt },
      { name: "Payment Gateways", icon: CreditCard },
      { name: "Banking APIs", icon: Bank },
      { name: "E-Commerce", icon: ShoppingCart },
      { name: "Biometric Systems", icon: Fingerprint },
      { name: "WhatsApp Business", icon: WhatsappLogo },
      { name: "Email Services", icon: Envelope },
    ],
  },
];
