...
const industriesData = [
  {
    ...
    desc: "Citizen services, public administration, infrastructure projects, procurement, compliance, and governance.",
    icon: <Bank size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Banking & Financial Institutions",
    desc: "Internal workflows, compliance, customer operations, approvals, and enterprise reporting.",
    icon: <CurrencyCircleDollar size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Infrastructure & EPC",
    desc: "Tender management, project execution, procurement, workforce, billing, asset tracking, and profitability.",
    icon: <HardHat size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Manufacturing",
    desc: "Production, inventory, procurement, quality management, and operational planning.",
    icon: <Factory size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Retail, D2C & Commerce",
    desc: "Inventory, finance, procurement, order management, warehousing, and customer operations — unified.",
    icon: <ShoppingCart size={26} className="text-[#FCCA71]" weight="light" />,
  },
  {
    title: "Healthcare",
    desc: "Hospital administration, procurement, HR, finance, compliance, and reporting.",
