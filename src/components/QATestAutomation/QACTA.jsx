    ...
    <section className="bg-transparent pt-2 pb-10 md:py-12 flex flex-col items-center justify-start relative w-full overflow-hidden transform-gpu font-sans z-20">
      ...
      >
        ...
        <img
          ...
          src="/CloudDevOps/cta_bg_pattern.svg"
          alt=""
          loading="lazy"
          decoding="async"
        />
        ...
        <div className="flex flex-col gap-4 items-center justify-start shrink-0 relative z-10 text-center max-w-4xl">
          ...
          >
            Enterprise applications, cloud-native platforms, AI systems, or digital products — we engineer quality into every release through intelligent automation and modern quality engineering.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center z-10 relative mt-4">
          <button
            onClick={() => handleNavigate("Talk to a Quality Engineering Expert")}
          ...
          <button
            onClick={() => handleNavigate("Build Your Test Automation Strategy")}
