...
import {
  Robot, SealCheck, ArrowsClockwise, Target, Infinity as InfinityIcon, ChartBar
} from "@phosphor-icons/react";

const whyData = [
  { icon: Robot, title: "Automation-First Engineering", desc: "Intelligent automation that improves release speed while reducing manual effort." },
  { icon: SealCheck, title: "Enterprise Quality Standards", desc: "Testing frameworks designed for complex, business-critical applications at enterprise scale." },
  { icon: ArrowsClockwise, title: "Continuous Quality Culture", desc: "Quality integrated into development, deployment, and operations — not a separate phase." },
  { icon: Target, title: "Operational Reliability", desc: "Software that performs consistently under real business conditions." },
  { icon: InfinityIcon, title: "Long-Term Quality Evolution", desc: "Testing frameworks that evolve alongside applications as technology landscapes change." },
  { icon: ChartBar, title: "Actionable Quality Insights", desc: "Metrics and reporting that give engineering leaders clear visibility into release readiness and risk." },
];

const QAWhyRevoSolve = () => {
  return (
    <section id="qa-why-revosolve" className="relative w-full pt-12 pb-16 lg:pt-20 lg:pb-24 overflow-hidden z-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-6 lg:gap-12 pb-6">
          ...
          <div className="max-w-xl lg:pb-1">
            <p className="text-[#CACBDB] text-sm font-normal leading-relaxed opacity-70 text-left">
              Software quality is not achieved through testing alone — it is achieved by embedding quality throughout the engineering lifecycle. 
            </p>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-start items-start w-full gap-3 relative z-10">
                  ...
                  {/* Card Description */}
                  <p className="text-[#AAA9BE] text-[13px] md:text-[14px] font-normal font-sans leading-relaxed text-left opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                    {item.desc}
                  </p>
                </div>
              </Motion.div>
