...
const methodSteps = [
  {
    title: "Discover",
    desc: "Assess existing development processes, testing maturity, release cycles, and quality objectives.",
    icon: MagnifyingGlass,
  },
  {
    title: "Design",
    desc: "Define enterprise quality strategies, automation architecture, test coverage, and governance frameworks.",
    icon: CompassTool,
  },
  {
    title: "Engineer",
    desc: "Develop automation frameworks, performance tests, API validation, and security testing capabilities.",
    icon: Code,
  },
  {
    title: "Integrate",
    desc: "Embed testing into DevOps pipelines, cloud environments, and software delivery processes.",
    icon: GitMerge,
  },
  {
    title: "Optimize",
    desc: "Continuously improve automation coverage, release quality, performance benchmarks, and productivity.",
    icon: ChartLineUp,
  },
];
